...
namespace DrBlackRat.VRC.ModernUI
{
    ...
    public class EsmButton : UdonSharpBehaviour
    {
        [Header("Settings:")] 
        ...
        private int item;
        private EconomySyncedMultiselect manager;
        ...
        public void _SetUpConnection(EconomySyncedMultiselect newManager, int newItem)
        {
            manager = newManager;
            item = newItem;
        }
